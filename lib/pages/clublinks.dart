  ...
  static Center buildBody() {
    return Center(
      ...
      child: Column(
          ...
          children: <Widget>[
            Text(
                "Here are a few links that are associated with Howth Golf Club. \n ",
            ...
            StyledButton(
                "https://www.howthgolfclub.ie/", "Howth Golf Club Website"),
            StyledButton("http://www.brsgolf.com/howth/visitor_menu.php",
                "Book a Tea Time"),
